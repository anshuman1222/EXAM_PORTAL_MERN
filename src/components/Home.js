...
import login from "../assets/login-bg1.png"
      ...
      <div className='md:grid grid-cols-3 items-center justify-items-end'>
            <div className=''>
                ...
                <div className='text-white my-4 mx-2 font-bold'>
                  <button className='rounded border border-[#c60fa2]  hover:bg-[#c60fa2] py-1 px-2 hover:scale-125 duration-300 text-xl'><Link to='/login'>Get Started</Link></button>
